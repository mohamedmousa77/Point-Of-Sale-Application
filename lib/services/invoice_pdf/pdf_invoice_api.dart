...
import 'package:pos_application/services/invoice_pdf/pdf_api.dart';
import 'package:pos_application/services/invoice_pdf/supplier_model.dart';
import 'package:pos_application/services/invoice_pdf/utils.dart';
...
class PdfInvoiceApi {
  static Future<File> generate(Invoice invoice) async {
    ...
    return PdfApi.saveDocument(name: 'invoiceTest', pdf: pdf);
  }
...
//       Row(
//         children: [
//           buildSupplierInfo(invoice.supplier),
//          Container(
//            height: 50,
//            width: 50,
//            child:  BarcodeWidget(
...
//   );
//
//   static Widget buildSupplierInfo(Supplier supplier)=>Column(
//     crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//       Text(supplier.name),
...
//       'Total'
//     ];
//     final data = invoice.items.map((element){
//       final total = element.unitPrice * element.quantity * (1+element.vat);
//       return [
//         element.description,
...
//         cellHeight: 30,
//         cellAlignments: {
//           0: Alignment.centerLeft,    // Column 0
//           1 : Alignment.centerRight,  // Column 1
//           2 : Alignment.centerRight,  // Column 2
